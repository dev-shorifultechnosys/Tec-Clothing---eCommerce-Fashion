...
<head>
    ...
    <title>Shop Full List || Clothing</title>
                                ...
                                <div class="col-xl-4 col-lg-3 col-md-2">
                                    <div class="list-grid-view text-center">
                                        <ul class="nav" role="tablist">
                                            ...
                                            <li role="presentation"><a class="active" href="#list" aria-controls="list" role="tab"
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="grid">
                                    <div class="total-shop-product-grid row">
                                        ...
                                        <div class="col-lg-3 d-md-none d-block d-lg-block item">
                                            <!-- single product start-->
                                            <div class="single-product">
                                                <div class="product-img">
                                                    <div class="product-label red">
                                            ...
                                            <div class="single-product single-product-list full-widht-list">
                                                ...
                                                <div class="product-text prodcut-text-list fix">
                                                    <div class="prodcut-name list-name montserrat"> <a
                                                            href="single-product.html">Magnetic Force Bralette</a>
                                                    </div>
                                                    <div class="prodcut-ratting-price">
                                                    ...
                                                    <div class="list-product-content">
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                            ...
                                                            blandit tortor. Aenean eget posuere augue, vel molestie
                                                            turpis.
