    ...
    <div class="wrapper compare">
        ...
        <div class="compare-area">
            <div class="container">
                <div class="row">
                   <div class="col-12">
                       <div class="compare-item-thumb ptb-35 fix row">
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <div class="product-icon socile-icon-tooltip text-center">
                                            <ul>
                                                <li><a href="#" data-tooltip="Quick View" class="q-view" data-bs-toggle="modal" data-bs-target=".modal"><i class="fa fa-eye"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                           ...
                           <div class="col-md-3 col-sm-4 col-xs-12">
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        <div class="single-prodcut-img  product-overlay pos-rltv">
                                            <a href="single-product.html"> <img alt="" src="images/product/05.jpg" class="primary-image"> <img alt="" src="images/product/04.jpg" class="secondary-image"> </a>
                                        </div>
                                        <div class="product-icon socile-icon-tooltip text-center">
                                            <ul>
                                                <li><a href="#" data-tooltip="Quick View" class="q-view" data-bs-toggle="modal" data-bs-target=".modal"><i class="fa fa-eye"></i></a></li>
                           ...
                           <div class="col-md-2 col-sm-4 col-xs-12">
                                ...
                                <div class="upload-prodcut text-center">
                                    <div class="upload-box">                                  
                                        ...
                                        <label for="file"> <img src="images/icons/compate.png" alt=""></label>
                                        <p>Add Product</p>
                                    </div>
                                </div>
                                <!-- single product end-->
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="copyrigth"> Copyright @ <a href="https://themeforest.net/user/codecarnival/portfolio">CodeCarnival</a> All right reserved </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
